  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-4"> 
                  <label for="exampleInputEmail1">New Department</label><br>
            ...
            <div class="row" style="font-size: 13px;">
                <div class="col-lg-12">
                  ...
                  <table id="tbltransfer" class="table-bordered table-responsive transfer_table" style="width: 100%">
                    <thead>
                        <tr>
                          <th style="width: 5%"></th>
      ...
      <div class="modal-footer">
        <div class="row">
          <div class="col-lg-12">
            <button id="btnPrintTransfer" type="button" class="btn btn-success">Print Fixed Asset Transfer</button>
            <button id="btnPrintReceipt" type="button" class="btn btn-info" disabled>Pull-out Receipt</button>
...
$('#btnPrintTransfer').click(function(e){
  ...
  $('.transfer_table td').each(function(){
    ...
    var oldLocation = data[4];
    var oldAssignee = data[7];
    var oldDept = data[9];
