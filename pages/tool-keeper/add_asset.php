                ...
                <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      ...
                      <select type="text" class="form-control js-example-basic-single" id="project" required="required" disabled>
                        <?php
                          $loc->status = 0;
                          $view = $loc->view_loc();
                          while($row=$view->fetch(PDO::FETCH_ASSOC))
                          {
                            if($_SESSION['project-id'] == $row['id']){
                              echo '<option value='.$row['id'].' selected>'.$row['code'].' - '.$row['location'].'</option>';
                            }
                          }
                        ?>
                      </select>
