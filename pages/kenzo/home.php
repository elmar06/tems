...
<div class="container-scroller">
  <!-- page navbar -->
  <?php 
    include '../../includes/kenzo_header.php'; 
  ?>
  <!-- main panel -->
          ...
          <div class="card">
            <div class="card-body">
              <div>
                ...
                <button id="btndelete" type="button" class="btn btn-danger btn-rounded" style="display: none"><i class="fa fa-trash-o"></i>Delete</button>
                ...
                <a href="home.php" class="btn btn-dark btn-rounded" ><span class ="fa fa-refresh"></span> Refresh Table</a>
