                ...
                <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      ...
                      <select type="text" class="form-control js-example-basic-single" id="project" required>
                        <?php
                          $loc->status = 0;
                          $view = $loc->view_loc();
                    ...
                    <div class="col-lg-4">
                      ...
                      <select type="text" class="form-control js-example-basic-single" id="category" name="category" required>
                        <?php
                          $type->status = 0;
                          $view = $type->view_type();
                          while($row=$view->fetch(PDO::FETCH_ASSOC))
                    ...
                    <div class="col-lg-4">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="code" disabled required>
                      </div>
                    </div>                    
                  </div><br>
                  <div class="row">
                    <div class="col-lg-4">
                      ...
                      <select type="text" class="form-control js-example-basic-single" id="trade" name="trade" required>
                        <?php
                          $view = $dept->view_dept();
                          while($row=$view->fetch(PDO::FETCH_ASSOC))
                          {
