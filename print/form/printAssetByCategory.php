	...
	while($asset_row = $view_asset->fetch(PDO::FETCH_ASSOC))
	{
		...
		$tbl .= '
			<tr>
				...
				<td width="15%" align="center" style="border-right-style:2px;">'.$location.'</td>
				<td width="15%" align="center" style="border-right-style:2px">'.$fullname.'</td>
...
<div>
	<label style="">Asset Category: <b><i><u>$asset_name</u></i></b></label><br>
</div>
<table width="100%" cellpadding="10" style="border-top-style:2px; border-left-style:2px; border-right-style:2px; border-bottom-style:2px; font-size: 10px">
	...
	<thead>
		<tr>
			...
			<td width="15%" align="center" style="border-top-style:2px; border-left-style:2px; border-bottom-style:2px">Location</td>
			<td width="15%" align="center" style="border-top-style:2px; border-left-style:2px; border-bottom-style:2px">Assignee</td>
